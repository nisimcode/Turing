...
from offline_benchmark_mutation_check import main as benchmark_mutation_check
...
def main() -> int:
    ...
    assert benchmark_mutation_check(["--require-perfect"]) == 0
    assert q21_check() == 0
    assert q24_check() == 0
    assert q25_check() == 0
    assert q26_check() == 0
    ...
    print("  independent mechanical-fault benchmark: PASS")
